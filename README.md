# jesuspalma4G
toledo es god toledo es vida toledo es todo jeje 
# 📝 Registro de Ejercicios - Identificación del Alumno

## 👤 Datos del Alumno
| Campo | Información |
|-------|-------------|
| Nombre completo | [jesus palma rambao] |
| Número de control | [24308051220643] |
| Grupo | [G] |
| Grado | [4] |
| Escuela | [Cbtis122] |
...
- Descripción:  2.10 La CONAGUA requiere determinar el pago que debe realizar una persona por el total de metros cúbicos que consume de agua. Realice una pagina web con css y js que permita determinar ese pago.
...
2.9 Se requiere determinar el costo que tendrá realizar una llamada telefónica con base en el tiempo que dura la llamada y en el costo por minuto. Realice una página web con JS que representen el algoritmo para tal fin.
  ...
  [Describe brevemente el ejercicio: objetivo, herramientas utilizadas, metodología, alcance, resultados o entregables esperados.]
